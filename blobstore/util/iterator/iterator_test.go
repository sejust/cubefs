...
var next iterator.Next[in, out] = func(_ context.Context, i *in, o *out) error {
...
var nexterr iterator.Next[in, out] = func(context.Context, *in, *out) error {
...
func TestUtilIteratorNext(t *testing.T) {
	...
	all := 0
	for {
		hasnext, err := iter.Next(context.Background())
